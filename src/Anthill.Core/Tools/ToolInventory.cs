...
public static class ToolInventory
{
    ...
    public static readonly IReadOnlySet<string> Implemented = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "colony_state",
        // v0.3.8.102: the system-operation lane. Both wrap the infrastructure ActionExecutor — the SAME
        ...
        // they only exist where a infrastructure repository exists. The names live in
