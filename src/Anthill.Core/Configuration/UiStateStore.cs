...
public static class UiStateStore
{
    ...
    /// other key — ant names, colours, chamber labels, map preferences — is returned untouched: a
    ...
    public static Dictionary<string, object?> WithSanitizedWorkspace(
        ...
        => DashboardWorkspaceState.SanitizeInto(state, knownPanelIds, viewportWidth, viewportHeight);
}
