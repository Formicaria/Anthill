...
/// <summary>
/// Infrastructure Target Allowlist guard (v1.9.0, NORTH_STAR D1). Deterministic infrastructure providers may
...
/// </summary>
public sealed class InfrastructureTargetGuard : IInfrastructureTargetGuard
{
    private readonly IInfrastructureRepository _repository;

    public InfrastructureTargetGuard(IInfrastructureRepository repository) => _repository = repository;
