...
public sealed class InfrastructureDashboard
{
...
{
    public static InfrastructureDashboard Build(IInfrastructureRepository repository, HealthCheckRunner health, int pendingApprovals = -1)
    {
        ...
        return new InfrastructureDashboard
        {
