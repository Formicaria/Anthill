...
namespace Anthill.Modules.Infrastructure.Backup;
...
public static class BackupIntelligence
{
    ...
    public static List<CoverageEntry> CoverageMap(InfrastructureRepository repo, DateTime nowUtc)
    {
    ...
    public static NodeLossImpact SimulateNodeLoss(InfrastructureRepository repo, string nodeId, DateTime nowUtc)
    {
    ...
    public static List<string> Runbook(InfrastructureRepository repo, string targetKind, string targetId, DateTime nowUtc)
    {
