...
/// — and the infrastructure `ActionExecutor`, the only production system that actually changes external
...
public static class ActionLifecycleBridge
{
    ...
    /// nothing optimistic. A infrastructure rollback NOTE is prose for a human, not a deterministic
