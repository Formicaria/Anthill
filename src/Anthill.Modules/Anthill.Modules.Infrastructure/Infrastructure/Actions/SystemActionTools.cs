...
/// <summary>
/// THE SPINE'S DOOR INTO THE APPROVAL PIPELINE. v0.3.8.102, PLAN.md §2b — "existing infrastructure
...
public static class SystemActionTools
{
    ...
    private sealed class ProposeTool : ITool
    {
        ...
        public string Description =>
            "Propose an allowlisted infrastructure action (restart_container, restart_vm, …) into the "
