...
/// <see cref="IInfrastructureActionRunner"/> it inherits every gate the framework already enforces: the
/// INFRASTRUCTURE_STOP kill switch checked before anything runs, blast-radius scoring, the structural
...
/// </summary>
public sealed class DockerActionRunner : IInfrastructureActionRunner
{
    /// <summary>
    ...
    /// infrastructure left the core in v3.8.7 and ModuleBoundaryTests enforces it by assembly reference —
