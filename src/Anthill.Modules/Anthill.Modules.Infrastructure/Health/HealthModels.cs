...
/// <summary>What to check, on the shared infrastructure scheduler cadence. Operator-managed.</summary>
public sealed class HealthCheckSchedule
{
    ...
    /// <summary>Per-check timeout override in ms; 0 = use the global infrastructure_health_timeout_ms.</summary>
...
/// approvals join in V2.1). Persisted as a infrastructure_events row and optionally pushed through the
