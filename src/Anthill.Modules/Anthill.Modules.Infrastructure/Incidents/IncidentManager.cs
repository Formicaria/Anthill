...
namespace Anthill.Modules.Infrastructure.Incidents;
...
///   it opened (suspects), health results and infrastructure events for its subject during it.
...
public sealed class IncidentManager
{
    ...
    /// colony memory or the skill registry — wiring those in here would couple the infrastructure
    ...
    public IncidentManager(IInfrastructureRepository repository, Action<IncidentRecord>? onOpened = null)
    {
    ...
    /// </summary>
    public System.Threading.Tasks.Task<InfrastructureProviderResult> SweepAsync(CancellationToken ct)
    {
        var opened = 0;
        ...
        return System.Threading.Tasks.Task.FromResult(
            InfrastructureProviderResult.Success($"incident sweep ok ({opened} opened)", opened));
    }
