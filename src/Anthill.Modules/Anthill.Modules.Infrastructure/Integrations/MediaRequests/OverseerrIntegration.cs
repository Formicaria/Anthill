...
namespace Anthill.Modules.Infrastructure.Integrations.MediaRequests;
...
/// checked against the D1 infrastructure allowlist before any I/O, a strict timeout, and secrets never
...
public sealed class OverseerrClient : IDisposable
{
    ...
    public OverseerrClient(string url, IInfrastructureTargetGuard targetGuard, Func<string?> apiKeyProvider)
    {
