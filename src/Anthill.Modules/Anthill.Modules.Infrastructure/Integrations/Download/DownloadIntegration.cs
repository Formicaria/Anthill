...
namespace Anthill.Modules.Infrastructure.Integrations.Download;
...
///
/// Discipline is identical to every other integration: the target host must be on the D1 infrastructure
...
public sealed class DownloadClient : IDisposable
{
    ...
    private readonly IInfrastructureTargetGuard _guard;
    ...
    public DownloadClient(string kind, string url, IInfrastructureTargetGuard guard, Func<string?> secretProvider, TimeSpan? timeout = null)
    {
...
/// no new tables, endpoints, or UI pages — the generic /infrastructure/integrations surface and the R2
