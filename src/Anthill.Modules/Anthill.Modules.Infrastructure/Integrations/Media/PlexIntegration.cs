...
namespace Anthill.Modules.Infrastructure.Integrations.Media;
...
/// per request from the credential store, the target host checked against the D1 infrastructure allowlist
...
public sealed class PlexClient : IDisposable
{
    ...
    public PlexClient(string url, IInfrastructureTargetGuard targetGuard, Func<string?> tokenProvider)
    {
