...
/// </summary>
public static class InfrastructureHttpClients
{
    ...
    public static readonly HttpClient Insecure = new(new HttpClientHandler
    {
        ...
        // Infrastructure hypervisors almost always run self-signed certs. Config-controlled per integration
        // (infrastructure_<kind>_insecure_tls, default false = verify). Same posture as the Proxmox client.
