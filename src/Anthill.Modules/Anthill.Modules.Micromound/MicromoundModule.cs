    ...
    public void Register(IModuleContext context)
    {
        ...
        context.Events.Publish(new ColonyEvent
        {
            ...
            Metadata = new Dictionary<string, object?>
            {
                ...
                // Reported as a capability of the module, not a claim about the token store:
                // enrollment token hashes are deliberately NOT ciphered (see SqliteMoundStore).
                ["cipher_available"] = _cipher?.Enabled ?? false,
