...
**Shipping release: v2.22.0** — the skills loop closes: a task records the procedure it followed, and a verified mission credits it. Previously v2.21.0 — Phases A–C of `docs/REMAINING_WORK.md`. Handoff ingestion: a
