...
The 3.8 line is CLOSED at v3.8.34. Two programs ran and both finished:
...
The twelve-role activation program (v3.8.19–v3.8.34) took the roster from "twelve registered roles,
...
State: main is at v3.8.34, tagged and green. 1,860+ tests.
