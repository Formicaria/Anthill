...
| Chambers in the wrong places; extra chambers | Positions re-derived at runtime | The seven positions are permanent literals. There are exactly seven sectors; `INFRASTRUCTURE` is not one of them. |
