...
public class CommandCenterTests : IDisposable
{
    ...
    public CommandCenterTests()
    {
        ...
        _repo = new InfrastructureRepository(Path.Combine(_dir, "cc.db"));
        _health = new HealthCheckRunner(_repo, new InfrastructureTargetGuard(_repo));
    }
    ...
    private (InfrastructureNode Host, ServiceRecord Svc, ServiceRecord Proxy) Seed()
    {
