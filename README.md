...
cd "$HOME/anthill"
curl -fLO https://github.com/Formicaria/Anthill/releases/download/v0.3.8.103/anthill-0.3.8.103-linux-x64.tar.gz
tar --no-same-owner -xzf anthill-0.3.8.103-linux-x64.tar.gz
chmod +x anthill
```
